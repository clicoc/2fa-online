  ...
  const htmlContent = `<!DOCTYPE html>
    ...
    <head>
      ...
      <style>
        ...
        .code:hover { opacity: 0.7; }
        .remain { color: #e74c3c; font-weight: bold; width: 80px; }
        
        .back-link { display: block; text-align: center; margin-top: 20px; color: #b2bec3; text-decoration: none; font-size: 0.8rem; }
...
MyAccount 4S6C7G..."></textarea>
        ...
        <a href="/" class="back-link">← Single OTP Mode</a>
      </div>
      ...
      <script>
        ...
        const i18n = {
          zh: { title: '批量验证码生成', btn: '开始生成', thAcc: '账号', thCode: '验证码 (点击复制)', thTime: '剩余', toast: '已复制', tip: '格式：账号 [空格/Tab] 密钥' },
          en: { title: 'Bulk 2FA', btn: 'Generate All', thAcc: 'Account', thCode: 'OTP (Click)', thTime: 'Left', toast: 'Copied', tip: 'Format: Account [Space/Tab] Secret' }
        };
        ...
        function loadAccounts() {
          ...
          for (let line of lines) {
            ...
            try {
              const name = parts[0];
              const secret = parts[1].trim().toUpperCase();
